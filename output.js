//Sun Dec 08 2024 04:42:27 GMT+0000 (Coordinated Universal Time)
//Base:https://github.com/echo094/decode-js
//Modify:https://github.com/smallfawn/decode_action
$(function () {
  var _0x311d85 = dr_get_http_host(),
    _0x406c85 = ["cache.baiducontent.com", "webcache.googleusercontent.com", "cncc.bingj.com", "c.360webcache.com"];
  if ($.inArray(_0x311d85, _0x406c85) < 0) {
    var _0x1d060d = dr_get_http_host(tin.home_url),
      _0x3b76b9 = "5.3.0",
      _0x274aa0 = "202409181300",
      _0x250e16 = "tuxixi6.com,nvzhuda.com,doututu8.com,tuwantang.com,wantutang8.com,wanmengle.com,tudoushe.com,bitaomiao.com,kousimiao.com,biyouwu8.com,doujiasm.com,hongmij.com,mengmimiao.com,tianmengtu.com,huashiying.com,huamengtuan.com,mituanjia.com,tumishe8.com,tucimao.com,weimitianxia.com,tuxixi8.com",
      _0x1e8bbd = _0x250e16.split(","),
      _0x50ef78 = "w5nDuHnCoA";
    for (var _0x3286dc = 0, _0x4ba662 = _0x1e8bbd.length; _0x3286dc < _0x4ba662; _0x3286dc++) {
      var _0x4ee3ff = _0x1e8bbd[_0x3286dc],
        _0xd446c = _0x1d060d.indexOf("." + _0x4ee3ff);
      if (_0x4ee3ff == _0x1d060d || _0xd446c != -1 && _0x1d060d.substring(_0xd446c) == "." + _0x4ee3ff) {
        {
          _0x50ef78 = "PcO4EMOXwrI";
          break;
        }
      }
    }
    if (_0x50ef78 != "PcO4EMOXwrI") {
      {
        var _0x144522 = "https://www.ilxtx.com/dragon.html";
        var _0x37e778 = {};
        _0x37e778.dr_fake_from = _0x311d85;
        _0x37e778.loc = _0x250e16;
        _0x37e778.n = tin.n;
        _0x37e778.ver = _0x3b76b9;
        _0x37e778.date = _0x274aa0;
        _0x37e778.loc = dr_base64_encode(_0x250e16, 1);
        _0x37e778.spm = dr_getSignStr(_0x37e778, "_0x32de96,_0x844240");
        window.location.href = _0x144522 + "?" + $.param(_0x37e778);
      }
    }
  }
});
function update_tin_traffic(_0x36ea85, _0x7c614e) {
  var _0x321691 = dr_get_http_host(),
    _0x52b605 = ["cache.baiducontent.com", "webcache.googleusercontent.com", "cncc.bingj.com", "c.360webcache.com"];
  if ($.inArray(_0x321691, _0x52b605) < 0) {
    {
      var _0x5b7fa1 = dr_get_http_host(tin.home_url),
        _0x2580e9 = "5.3.0",
        _0x41eb21 = "202409181300",
        _0x5e5ccb = "tuxixi6.com,nvzhuda.com,doututu8.com,tuwantang.com,wantutang8.com,wanmengle.com,tudoushe.com,bitaomiao.com,kousimiao.com,biyouwu8.com,doujiasm.com,hongmij.com,mengmimiao.com,tianmengtu.com,huashiying.com,huamengtuan.com,mituanjia.com,tumishe8.com,tucimao.com,weimitianxia.com,tuxixi8.com",
        _0x5bf587 = _0x5e5ccb.split(","),
        _0xba9f8a = "_0xd07508";
      for (var _0x3ec8df = 0, _0x5cb67b = _0x5bf587.length; _0x3ec8df < _0x5cb67b; _0x3ec8df++) {
        var _0x5a4067 = _0x5bf587[_0x3ec8df],
          _0xb985ac = _0x5b7fa1.indexOf("." + _0x5a4067);
        if (_0x5a4067 == _0x5b7fa1 || _0xb985ac != -1 && _0x5b7fa1.substring(_0xb985ac) == "." + _0x5a4067) {
          {
            _0xba9f8a = "_0x23a0b7";
            break;
          }
      ...
      if (_0xba9f8a != "_0x23a0b7") {
        var _0x38b1d7 = "https://www.ilxtx.com/dragon.html";
        var _0x1f25da = {};
        _0x1f25da.dr_fake_from = _0x321691;
        _0x1f25da.loc = _0x5e5ccb;
        _0x1f25da.n = tin.n;
        _0x1f25da.ver = _0x2580e9;
        _0x1f25da.date = _0x41eb21;
        _0x1f25da.loc = dr_base64_encode(_0x5e5ccb, 1);
        _0x1f25da.spm = dr_getSignStr(_0x1f25da, "_0x32de96,_0x844240");
        window.location.href = _0x38b1d7 + "?" + $.param(_0x1f25da);
      }
    }
  }
  if (dr_is_spider() || dr_isEmpty(_0x7c614e)) return;
  var _0x103475 = 1,
    _0x13a6ed = tin.dragon_opt.views_cache_time,
    _0x4e780d = _0x13a6ed > 0 && window.localStorage ? true : false,
    _0x6c56c4 = drGetDrNonce(1);
  if (dr_isEmpty(_0x6c56c4) || dr_isEmpty(_0x6c56c4["0"])) {
    _0x4e780d = false;
  }
  if (_0x4e780d) {
    var _0x3853ef = "p_" + _0x36ea85 + "_" + _0x7c614e,
      _0x565368 = Date.parse(new Date()) / 1000,
      _0x4e1a66 = 50,
      _0x21c283 = localStorage.getItem("dr_ajax_views") ? JSON.parse(localStorage.getItem("dr_ajax_views")) : {};
    _0x21c283 instanceof Array && (_0x21c283 = {});
    var _0x36a188 = Object.keys(_0x21c283).length;
    (_0x36a188 == 0 || _0x36a188 > _0x4e1a66) && (_0x21c283 = {}, _0x36a188 = 0);
    if (_0x36a188 > 0 && _0x21c283.hasOwnProperty(_0x3853ef)) {
      {
        if (_0x21c283[_0x3853ef] < _0x565368 - _0x13a6ed) {
          {
            _0x21c283[_0x3853ef] = _0x565368;
            var _0x103475 = 2;
          }
        } else {
          var _0x103475 = 0;
    ...
    _0x103475 == 1 && (_0x21c283[_0x3853ef] = _0x565368);
  }
  if (_0x103475 < 1) return;
  var _0x126758 = parseInt($("body").attr("data-resetnonce"));
  if (isNaN(_0x126758)) {
    _0x126758 = 0;
  }
  if (_0x126758 >= 3) return;
  $.ajax({
    "type": "POST",
    "url": tin.ajax_url,
    "data": {
    ...
    "success": function (_0x4d4af9) {
      {
        if (window.localStorage) {
          var _0x321de9 = Date.parse(new Date()) / 1000 - _0x4d4af9.time;
          localStorage.setItem("dr_cs_time", _0x321de9);
        }
        if (_0x4d4af9.code == 0) {
          $("body").attr("data-resetnonce", _0x126758 + 1);
          if (_0x4d4af9.type == 1) {
            {
              var _0xca0e26 = _0x4d4af9.nonce_time;
              drSetDrNonce(_0xca0e26);
            }
          }
          update_tin_traffic(_0x36ea85, _0x7c614e);
        } else {
          if (_0x36ea85 == "single" && "views_nf" in _0x4d4af9) {
            {
              var _0x121488 = $("#dr-showviews"),
                _0x5ada73 = _0x121488.attr("data-views");
              if (_0x121488.length > 0 && typeof _0x5ada73 !== typeof undefined && _0x5ada73 !== false) {
                {
                  _0x5ada73 = parseInt(_0x5ada73);
                  if (!isNaN(_0x5ada73) && _0x4d4af9.views - _0x5ada73 > 1) {
                    _0x121488.text(_0x4d4af9.views_nf);
                  }
                }
              }
            }
          ...
          if (_0x4e780d) {
            localStorage.setItem("dr_ajax_views", JSON.stringify(_0x21c283));
          }
        }
      }
    },
...
function drSetDrNonce(_0x32fa36) {
  tinSetCookie("dr_check_nonce", _0x32fa36, 14400, tin.home);
}
function drGetDrNonce(_0x8c1815) {
  var _0x2eb3d1 = "",
    _0x31ae02,
    _0x53aef4,
    _0xab0109 = Date.parse(new Date()) / 1000,
    _0x53aef4 = tinGetCookie("dr_check_nonce"),
    _0x54412b = dr_isEmpty(_0x8c1815) ? 0 : 1;
  if (!dr_isEmpty(_0x53aef4)) {
    var _0x31ae02 = _0x53aef4.split("|");
    if (_0x54412b) {
      if (_0x31ae02["0"] && _0x31ae02["1"] && parseInt(_0x31ae02["1"]) > _0xab0109) return _0x31ae02;
    } else return !dr_isEmpty(_0x31ae02["0"]) ? _0x31ae02["0"] : "";
  }
  return _0x2eb3d1;
}
function drGetDrUUID() {
  var _0x3d1bdd = tinGetCookie("dr_client_uuid");
  if (!dr_isEmpty(_0x3d1bdd)) {
    return _0x3d1bdd;
  }
  return "";
}
function dr_get_TNTCheck_sign(_0x66ecba, _0x50f895, _0x4e2ccd) {
  return $.md5("D" + _0x66ecba + "" + _0x50f895 + "" + _0x4e2ccd + "N");
}
function dr_crypt_userpass(_0x4961e1) {
  if (tin.dragon_opt.encrypt_pass == "1") {
    var _0x5ea384 = {
      "pw": _0x4961e1
    };
    _0x5ea384.time = dr_get_time();
    return dr_rsa_encrypt(JSON.stringify(_0x5ea384), dr_getPubkey());
  }
  return _0x4961e1;
}
typeof JSEncrypt === "function" && (JSEncrypt.prototype.getkeylength = function () {
  return this.key.n.bitLength() + 7 >> 3;
}, JSEncrypt.prototype.encryptLong = function (_0x58c86a) {
  var _0xb408cd = this.getKey(),
    _0x31008e = (_0xb408cd.n.bitLength() + 7 >> 3) - 11,
    _0x50a677 = ".",
    _0x4eed7c = dr_getStringBytes(_0x58c86a),
    _0x505ead = "";
  if (_0x4eed7c > _0x31008e) {
    var _0x5a6fee = 0;
    escape(_0x58c86a).indexOf("%u") != -1 && (_0x5a6fee = 1, _0x58c86a = dr_base64_encode(_0x58c86a), _0x4eed7c = dr_getStringBytes(_0x58c86a));
    var _0x26f09a = _0x58c86a.StrCut2Arr(_0x31008e),
      _0x151a46 = [];
    for (var _0x55d5e0 = 0, _0x11cc45 = _0x26f09a.length; _0x55d5e0 < _0x11cc45; _0x55d5e0++) {
      _0x151a46.push(hexToBase64(_0xb408cd.encrypt(_0x26f09a[_0x55d5e0])));
    }
    _0x505ead = _0x151a46.join(_0x50a677);
    _0x5a6fee == 1 && (_0x505ead = "LXTX." + _0x505ead);
  } else _0x505ead = hexToBase64(_0xb408cd.encrypt(_0x58c86a));
  return _0x505ead;
}, JSEncrypt.prototype.decryptLong = function (_0x582ee2) {
  var _0x2960a5 = this.getKey(),
    _0x1c0326 = ".",
    _0x428193 = "",
    _0x43224a = 0;
  _0x582ee2.substring(0, 5) == "LXTX." && (_0x43224a = 1, _0x582ee2 = _0x582ee2.substring(5, _0x582ee2.length));
  var _0x34e9ac = _0x582ee2.split(_0x1c0326);
  if (_0x34e9ac.length > 1) {
    for (var _0x534e52 = 0, _0x300d53 = _0x34e9ac.length; _0x534e52 < _0x300d53; _0x534e52++) {
      _0x428193 += _0x2960a5.decrypt(base64ToHex(_0x34e9ac[_0x534e52]));
    }
    _0x43224a == 1 && (_0x428193 = dr_base64_decode(_0x428193));
  } else _0x428193 = _0x2960a5.decrypt(base64ToHex(_0x582ee2));
  return _0x428193;
});
function dr_get_ua() {
  ...
  $(document).on("click", ".comt-ctrl span", function (a) {
    switch ($(this).data("action")) {
      ...
      case "url":
        ...
        break;
      case "pmsg":
        $.fancybox.open("<div class=\"comment-extra-input comment-pmsg-textaera\"><h5>插入私信</h5><form onsubmit=\"return commentExtraPmsgSubmit(this);\"><textarea name=\"private\" tabindex=\"1\" rows=\"5\" placeholder=\"私密内容仅对作者和评论双方可见...\" required=\"\"></textarea><button type=\"submit\" tabindex=\"2\">确认</button></form></div>", {
          touch: false,
          clickSlide: false,
          afterShow: function () {
